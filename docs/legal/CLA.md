...
This Agreement clarifies the intellectual property license granted with Contributions from any person or entity. It is for your protection as a Contributor as well as the protection of the Copyright Holder and the Project's users. This Agreement does not change your rights to use your own Contributions for any other purpose.

## Definitions

**"You"** (or **"Your"**) means the individual or legal entity agreeing to this Agreement.
...
You hereby **assign and transfer** to Jordan Ritz all right, title, and interest worldwide in all copyright in Your Contributions, including all rights of any kind whatsoever accruing under the Copyright Act of 1976 (17 U.S.C. § 101 et seq.) and all foreign counterparts thereto.

This assignment includes, without limitation:

- The right to reproduce, prepare derivative works, publicly display, publicly perform, distribute, and sublicense Your Contributions
- The right to enforce the copyright in Your Contributions
- All renewals and extensions of copyright
- All rights under moral rights laws (to the extent assignable)
...
- All terms of this Agreement will continue to apply
...
**a) Original Work**: You are the sole author of Your Contributions, or You have sufficient rights from the copyright holder(s) to make this assignment.

**b) Legal Capacity**: You are legally entitled to grant the above assignment and licenses. If Your employer(s) has rights to intellectual property that You create, You represent that:
...
**c) No Third-Party Claims**: Your Contribution does not violate any third-party intellectual property rights, including patents, copyrights, trademarks, or trade secrets.
...
You agree to notify the Copyright Holder in writing of any facts or circumstances of which You become aware that would make Your representations in Section 5 inaccurate in any respect.

### 7. Employer Contributions

If You are making a Contribution on behalf of Your employer, or Your employer has intellectual property rights in Your Contributions, You represent that You have been authorized by Your employer to enter into this Agreement on behalf of Your employer. In such case, "You" in this Agreement refers to both You individually and Your employer.

### 8. Support and Warranty Disclaimer
...
**UNLESS REQUIRED BY APPLICABLE LAW OR AGREED TO IN WRITING, YOUR CONTRIBUTIONS ARE PROVIDED "AS IS", WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, WITHOUT LIMITATION, ANY WARRANTIES OR CONDITIONS OF TITLE, NON-INFRINGEMENT, MERCHANTABILITY, OR FITNESS FOR A PARTICULAR PURPOSE.**

### 9. Liability Limitation

**IN NO EVENT WILL YOU BE LIABLE TO THE COPYRIGHT HOLDER OR ANY THIRD PARTY FOR ANY LOST PROFITS OR ANY INDIRECT, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR RELATED TO THIS AGREEMENT OR YOUR CONTRIBUTIONS, EVEN IF YOU HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.**
...
Any legal action or proceeding arising under this Agreement will be brought exclusively in the federal or state courts located in San Francisco County, California, and You hereby consent to personal jurisdiction and venue therein.

### 11. Entire Agreement

This Agreement constitutes the entire agreement between You and the Copyright Holder regarding Your Contributions and supersedes all prior agreements, understandings, and communications.

### 12. Amendments

The Copyright Holder may amend this Agreement at any time by posting a new version. Contributions made after the amendment becomes effective will be subject to the amended Agreement.

### 13. Severability

If any provision of this Agreement is found to be invalid or unenforceable, the remaining provisions will remain in full force and effect, and the invalid or unenforceable provision will be reformed to the extent necessary to make it valid and enforceable.

---

## How to Sign This Agreement

By making a Contribution to the Project, You indicate Your acceptance of this Agreement. This can be done in one of the following ways:

### Method 1: Individual Contributors (Recommended)

Add your name, email, and date to the `CONTRIBUTORS.md` file in the root of the repository as part of your first Pull Request:

```markdown
- [Your Full Name] <your.email@example.com> - YYYY-MM-DD
```

### Method 2: Corporate Contributors

If contributing on behalf of a corporation, have an authorized representative add the corporation's information to `CONTRIBUTORS.md`:

```markdown
- [Company Name] (authorized by [Full Name] <email@example.com>) - YYYY-MM-DD
```

For corporate contributions, we may require additional documentation demonstrating authorization.

### Method 3: CLA Assistant (Automated)

If the Project has enabled CLA Assistant automation, You will be prompted to sign this Agreement electronically when You submit Your first Pull Request. Follow the prompts provided by the CLA Assistant bot.
...
1. Open an issue in the Project's GitHub repository with the label `legal`
2. Email the Copyright Holder: jordan@cfg.is (when available)
3. Consult with Your own legal counsel
