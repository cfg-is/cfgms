...
- [x] Fix Docker networking in MQTT+QUIC E2E tests (Issue #382 - 2-3 points) - Fix hardcoded `localhost:4433` QUIC address to use Docker service name `controller-standalone:4433` for container-to-container communication ✅ COMPLETED
