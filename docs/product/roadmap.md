...
- [ ] **Steward log pull** — `cfg steward logs` exists but the controller route returns 501; implement log retrieval from the steward or remove the command (fix issue filed). `cms`
