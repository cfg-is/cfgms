...
This ADR ratifies the direction. Implementation is tracked by the epic **Storage Architecture: Five-Type Data Taxonomy (ADR-002)** with the following sub-stories (priorities reflect SaaS-unblock ordering):
