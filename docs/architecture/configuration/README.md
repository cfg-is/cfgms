...
This directory contains documentation about CFGMS's configuration management system.

## Contents

- [Overview](./overview.md) - Introduction to configuration management in CFGMS
...
- [Configuration Generation](./configuration-generation.md) - How configurations are generated and compiled
- [Change Management](./change-management.md) - How configuration changes are tracked and managed
