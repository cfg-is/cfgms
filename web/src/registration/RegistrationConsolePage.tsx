...
/*
 * Registration console tab shell (Story #2934).
 * Renders the /registration route with a tab strip: Pending (this story),
 * Tokens (Story #2935), IP Trust (Story #2936). Opens on Pending by default.
 *
 ...
 *
 * No approve, approve-all, or approve-by-CIDR control is present — those
 * are Section 2's follow-on epic (same mockup, different story).
 */
...
export const TABS: readonly TabSpec[] = [
  ...
  { key: 'tokens', label: 'Tokens', soon: true },
