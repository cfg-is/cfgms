...
type LogEntry struct {
	...
	CorrelationId string                 `protobuf:"bytes,6,opt,name=correlation_id,json=correlationId,proto3" json:"correlation_id,omitempty"` // detection↔outcome correlation (ADR-012 §1)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TelemetryRequest) Reset() {
	*x = TelemetryRequest{}
	mi := &file_transport_data_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TelemetryRequest) Descriptor() ([]byte, []int) {
	return file_transport_data_proto_rawDescGZIP(), []int{9}
}

func (x *TelemetryRequest) GetStewardId() string {
	if x != nil {
		return x.StewardId
	}
	return ""
...
func (x *TelemetryRequest) GetSubscribe() bool {
	if x != nil {
		return x.Subscribe
	}
	return false
...
type ProcessSnapshot struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	FragmentId     string                 `protobuf:"bytes,1,opt,name=fragment_id,json=fragmentId,proto3" json:"fragment_id,omitempty"` // ADR-017 typed entity id: "process:<name>"
...
func (x *ProcessSnapshot) Reset() {
	*x = ProcessSnapshot{}
	mi := &file_transport_data_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProcessSnapshot) Descriptor() ([]byte, []int) {
	return file_transport_data_proto_rawDescGZIP(), []int{10}
}

func (x *ProcessSnapshot) GetFragmentId() string {
	if x != nil {
		return x.FragmentId
	}
	return ""
...
func (x *ProcessSnapshot) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *ProcessSnapshot) GetMemoryBytes() uint64 {
	if x != nil {
...
func (x *ProcessSnapshot) GetDiskReadBytes() uint64 {
	if x != nil {
...
func (x *ProcessSnapshot) GetDiskWriteBytes() uint64 {
	if x != nil {
...
func (x *ProcessSnapshot) GetNetRxBytes() uint64 {
	if x != nil {
		return x.NetRxBytes
	}
	return 0
...
func (x *ProcessSnapshot) GetNetTxBytes() uint64 {
	if x != nil {
		return x.NetTxBytes
	}
	return 0
...
type ServiceSnapshot struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FragmentId    string                 `protobuf:"bytes,1,opt,name=fragment_id,json=fragmentId,proto3" json:"fragment_id,omitempty"` // ADR-017 typed entity id: "service:<name>"
...
func (x *ServiceSnapshot) Reset() {
	*x = ServiceSnapshot{}
	mi := &file_transport_data_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ServiceSnapshot) Descriptor() ([]byte, []int) {
	return file_transport_data_proto_rawDescGZIP(), []int{11}
}

func (x *ServiceSnapshot) GetFragmentId() string {
	if x != nil {
		return x.FragmentId
	}
	return ""
...
func (x *ServiceSnapshot) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ServiceSnapshot) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *TelemetrySnapshot) Reset() {
	*x = TelemetrySnapshot{}
	mi := &file_transport_data_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TelemetrySnapshot) Descriptor() ([]byte, []int) {
	return file_transport_data_proto_rawDescGZIP(), []int{12}
}

func (x *TelemetrySnapshot) GetStewardId() string {
	if x != nil {
		return x.StewardId
	}
	return ""
...
func (x *TelemetrySnapshot) GetProcesses() []*ProcessSnapshot {
	if x != nil {
		return x.Processes
	}
	return nil
...
func (x *TelemetrySnapshot) GetServices() []*ServiceSnapshot {
	if x != nil {
		return x.Services
	}
	return nil
...
const file_transport_data_proto_rawDesc = "" +
	...
	"\x04cols\x18\x05 \x01(\x05R\x04cols\"\xcf\x02\n" +
	"\bLogEntry\x12\x1d\n" +
	"\n" +
	"steward_id\x18\x01 \x01(\tR\tstewardId\x12/\n" +
	...
	"\x06fields\x18\x05 \x03(\v2%.cfgms.transport.LogEntry.FieldsEntryR\x06fields\x12%\n" +
	...
	"\facknowledged\x18\x02 \x01(\bR\facknowledged\"p\n" +
...
var file_transport_data_proto_goTypes = []any{
	...
	(*TelemetryRequest)(nil),      // 11: cfgms.transport.TelemetryRequest
