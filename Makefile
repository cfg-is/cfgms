...
generate-test-certificates: build-controller  ## Generate test certificates using native cert management
	...
	@echo ""
	@echo "Step 1: Starting controller to auto-generate valid certificates..."
	@mkdir -p test/integration/mqtt_quic/certs/ca
	@timeout 30 ./bin/controller --config test/integration/configs/controller-test.yaml > /tmp/controller-cert-gen.log 2>&1 & \
	CONTROLLER_PID=$$!; \
	sleep 5; \
	kill $$CONTROLLER_PID 2>/dev/null || true; \
	wait $$CONTROLLER_PID 2>/dev/null || true
	@if [ ! -f "test/integration/mqtt_quic/certs/ca-cert.pem" ]; then \
	...
	@echo ""
	@echo "Step 2: Generating invalid certificates for negative testing..."
