...
// backed by the shared connection pool db (owned by DatabaseProvider).
func NewDatabaseConfigStore(db *sql.DB, config map[string]interface{}) (*DatabaseConfigStore, error) {
