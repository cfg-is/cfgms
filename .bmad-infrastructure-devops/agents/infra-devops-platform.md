...
```yaml
IDE-FILE-RESOLUTION: Dependencies map to files as .bmad-infrastructure-devops/{type}/{name}, type=folder (tasks/templates/checklists/data/utils), name=file-name. For example if dependencies.tasks includes create-doc.md, this means you would use `.bmad-infrastructure-devops/tasks/create-doc.md`.
