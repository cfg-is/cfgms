...
func (m *MockPermissionStore) CreatePermission(ctx context.Context, permission *common.Permission) error { return nil }
func (m *MockPermissionStore) GetPermission(ctx context.Context, id string) (*common.Permission, error) { return nil, nil }
func (m *MockPermissionStore) ListPermissions(ctx context.Context, resourceType string) ([]*common.Permission, error) { return nil, nil }
func (m *MockPermissionStore) UpdatePermission(ctx context.Context, permission *common.Permission) error { return nil }
...
func (m *MockRoleStore) GetRole(ctx context.Context, id string) (*common.Role, error) { return nil, nil }
func (m *MockRoleStore) ListRoles(ctx context.Context, tenantID string) ([]*common.Role, error) { return nil, nil }
...
func (m *MockRoleStore) GetRoleHierarchy(ctx context.Context, roleID string) (*memory.RoleHierarchy, error) { return nil, nil }
func (m *MockRoleStore) GetChildRoles(ctx context.Context, roleID string) ([]*common.Role, error) { return nil, nil }
func (m *MockRoleStore) GetParentRole(ctx context.Context, roleID string) (*common.Role, error) { return nil, nil }
func (m *MockRoleStore) SetRoleParent(ctx context.Context, roleID, parentRoleID string, inheritanceType common.RoleInheritanceType) error { return nil }
...
func (m *MockSubjectStore) CreateSubject(ctx context.Context, subject *common.Subject) error { return nil }
...
func (m *MockSubjectStore) ListSubjects(ctx context.Context, tenantID string, subjectType common.SubjectType) ([]*common.Subject, error) { return nil, nil }
func (m *MockSubjectStore) UpdateSubject(ctx context.Context, subject *common.Subject) error { return nil }
...
func (m *MockRoleAssignmentStore) AssignRole(ctx context.Context, assignment *common.RoleAssignment) error { return nil }
func (m *MockRoleAssignmentStore) RevokeRole(ctx context.Context, subjectID, roleID, tenantID string) error { return nil }
func (m *MockRoleAssignmentStore) GetAssignment(ctx context.Context, id string) (*common.RoleAssignment, error) { return nil, nil }
func (m *MockRoleAssignmentStore) ListAssignments(ctx context.Context, subjectID, roleID, tenantID string) ([]*common.RoleAssignment, error) { return nil, nil }
func (m *MockRoleAssignmentStore) GetSubjectAssignments(ctx context.Context, subjectID, tenantID string) ([]*common.RoleAssignment, error) { return nil, nil }
