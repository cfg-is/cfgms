...
type Server struct {
	...
	stewardPublisherStore   trust.TrustStore                  // Issue #1944: publisher trust store for steward binary verification; nil = use CFGMSPublisherIdentity()
...
func (s *Server) setupRouter() {
	...
	// Steward binary publish/download endpoints (Issue #1944).
	// Distinct namespace "steward-binaries" from "installers" (install-package flow).
