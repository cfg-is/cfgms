...
func TestHealthTracker_RegisterAndGet(t *testing.T) {
...
func TestHealthTracker_RegisterDuplicate(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_UpdateHeartbeat_PromotesToActive(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_UpdateHeartbeat_UpdatesEphemeralMetrics(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_UpdateHeartbeat_NotFound(t *testing.T) {
	tracker := newTestTracker(t)
	err := tracker.UpdateHeartbeat(context.Background(), "ghost")
	assert.ErrorIs(t, err, business.ErrStewardNotFound)
}

func TestHealthTracker_MarkLost(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_DeregisterSteward(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_ListStewards(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_ListActiveStewards(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
	...
	require.NoError(t, tracker.UpdateHeartbeat(ctx, "s-active"))
...
func TestHealthTracker_EphemeralMetricsNotPersisted(t *testing.T) {
	root := t.TempDir()
	ctx := context.Background()
...
func TestHealthTracker_RecordTaskLatency(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_RecordConfigError(t *testing.T) {
	tracker := newTestTracker(t)
	ctx := context.Background()
...
func TestHealthTracker_GetEphemeralMetrics_UnknownSteward(t *testing.T) {
	tracker := newTestTracker(t)
