...
// cfgms-module-file is the out-of-process gRPC binary for the file stdlib module
// (handles type: file, type: directory, and type: symlink).
...
import (
	...
	filemodule "github.com/cfgis/cfgms/features/modules/file"
...
func main() {
	...
	srv := grpc.NewServer()
	proto.RegisterModuleServiceServer(srv, adapter.New(filemodule.New(), "file", srv))
	...
	if err := srv.Serve(lis); err != nil {
		log.Fatalf("cfgms-module-file: gRPC server exited with error: %v", err)
	}
}
